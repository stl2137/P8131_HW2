...
knitr::kable(total_dose_table, col.names = c("Estimate of Beta", "Low CI for Beta", "High CI for Beta", "Deviance", "Probability of Death Given Dose = 0.01"), row.names = c("logit", "probit", "c-log-log"), digits = 4)
```
...
For the logit model, we are 95% confidence that the LD50 dose is between 5.5096 and 9.9096.
